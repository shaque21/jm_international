                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 border">
                            ...
                            <div class="form-group row border">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" id="product_img" class="form-control custom_form_control" name="product_img" value="{{ old('product_img') }}" onchange="previewFile(this);">
                                  <img id="previewImg" class="mt-2 custom_form_control" src="{{ asset('uploads/users/products.jpg') }}" alt="Photo" width="150px">
