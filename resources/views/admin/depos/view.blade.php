...
@section('page_title','View Depo Information')
                ...
                <div class="row">
                    <div class="col-md-8 d-flex align-items-center">
                        <h2 class="text-uppercase text-dark font-weight-bold custom_h_size">
                            View Depo Information
                        </h2>
                    </div>
                    <div class="col-md-4 d-flex justify-content-end">
                        <a href="{{ url('/admin/depos/edit/'.$data['0']->depo_slug) }}" class="btn btn-secondary btn-sm font-weight-bold text-uppercase">
            ...
            <div class="card-body">
                ...
                <div class="row border">
                    <div class="view_img_container col-md-4 border p-2 d-flex justify-content-center align-items-center">
                        <img src="{{asset('/uploads/users/depo.png')}}" alt="..." class="container-fluid avatar-img rounded profile_img">
                    </div>
